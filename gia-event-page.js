...
(function(){
  ...
  *,*::before,*::after{box-sizing:border-box;}
  ...
  .reel.is-static{cursor:default;}
  .reel.is-static img.still{width:100%;height:100%;object-fit:cover;display:block;}
  .reel.is-static:hover img.still{transform:none;}
  ...
  .foot-brand .lead{color:var(--ink-2);font-size:.78rem;margin-top:16px;}
  ...
  .foot-col h4{font-size:.64rem;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-2);margin:0 0 18px;font-weight:700;}
  .foot-col a{display:block;color:var(--ink);opacity:.82;font-size:.8rem;margin-bottom:12px;transition:opacity .2s,color .2s;}
  ...
  .foot-bottom{display:flex;justify-content:space-between;gap:20px;flex-wrap:wrap;padding-top:28px;border-top:1px solid var(--rule-2);color:var(--ink-2);font-size:.72rem;}
  ...
  <div class="wrap">
    ...
    <div class="spk-reels">
      ...
      <div class="reel" data-reel="FEATURED reel" data-video="https://video.wixstatic.com/video/111174_4bae9d25a1e448268f4061e3600cd736/720p/mp4/file.mp4">
        <img class="still" src="https://static.wixstatic.com/media/111174_6073b6c9732d493e826c65fae750af22~mv2.png/v1/fill/w_600,h_1066,q_90,enc_auto/file.png" alt="Luke Anning, Featured Speaker - A 7 Figure Identity" loading="lazy" style="width:100%;height:100%;object-fit:cover;display:block">
